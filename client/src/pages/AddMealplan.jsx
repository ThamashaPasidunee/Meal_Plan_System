...
export default function AddMealplan() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("http://localhost:8081/api/v1/Meal/CrateMeal", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center items-center">
        <form
          className="flex flex-col gap-4 w-[600px]  rounded-lg border    mb-10 mt-5"
        ...
        >
          <div className="flex flex-col gap-4 ">
            <div className="flex gap-4 items-center justify-between border-none p-3">
              <label
                htmlFor="uploadInput"
                className=" border rounded-xl w-96 h-20 cursor-pointer"
              >
                <div className="mt-5">
              ...
              <button
                type="button"
                className="w-28 h-8 font-medium text-sm hover:opacity-80 rounded-lg bg-gradient-to-r from-blue-500 border  to-blue-800 text-white"
                size="sm"
          ...
          <div className="flex justify-center items-center">
            <input
              className=" border ml-2  h-10 rounded-md w-[450px] text-slate-800"
              type="text"
              placeholder=" Title"
              id="title"
              required
          ...
          <div className="flex gap-4">
            <textarea
              ...
              id="desc"
              maxLength={100}
              className=" border rounded-md w-[450px] ml-[80px] text-slate-800 h-20"
              onChange={(e) =>
